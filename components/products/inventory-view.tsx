...
export function InventoryView() {
  ...
  const {
    ...
    // Saat debouncedSearch="" data sudah di-prefetch dari server via HydrationBoundary.
    // queryFn hanya dijalankan saat search berubah atau cache stale.
    queryFn: () => {
      const url = debouncedSearch
        ? `/api/v1/products?q=${encodeURIComponent(debouncedSearch)}`
        : "/api/v1/products";
  ...
  return (
    <div className="space-y-6">
      ...
      <BentoCard className="overflow-hidden p-0">
        <div className="p-4 border-b border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-white/2 flex items-center justify-between gap-4">
